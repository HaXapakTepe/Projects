var points = [
  [
    '<div class="map-baloon"><p></p><p>ул. Клиническая, 97, к.1, Саратов, Саратовская обл., 410053</p></div>',
    '51.5360478',
    '45.9581039',
  ],
  [
    '<div class="map-baloon"><p></p><p>Полиграфическая ул., 3, Энгельс, Россия</p></div>',
    '51.49354394',
    '46.14838318',
  ],
  [
    '<div class="map-baloon"><p></p><p>Пионерская ул., 59А, Вольск, Россия</p></div>',
    '52.03481234',
    '47.37644949',
  ],
]
  ...
  for (i = 0; i < points.length; i++) {
    var myPlacemark = new ymaps.Placemark(
      ...
      },
      {
        ...
        iconImageHref: '../wp-content/themes/onko/images/icons/marker-black.svg',
        // Размеры метки.
        // iconImageSize: [50, 50],
