$(document).ready(function () {
  ...
  if (window.innerWidth > 1200) {
    const video = document.getElementById('video'),
      ...
      timePoints = [5, 10, 14, 18, 22, 27, 31, 35, 39],
      timePointsReverse = [36, 31, 27, 23, 19, 14, 11, 6, 2]
    ...
    $('#fullpage').fullpage({
      ...
      onLeave: function (index, nextIndex, direction) {
        ...
        //   $('.two .content__inner').addClass('animate__animated animate__fadeInRight').css({
        //     animationDelay: '2s',
        //   })
        ...
        //   $('.five .content__inner').addClass('animate__animated animate__fadeInLeft').css({
        //     animationDelay: '2s',
        //   })
        ...
        //   nextIndex == 8
        // ) {
        //   $('.eight .content__inner').addClass('animate__animated animate__fadeInLeft').css({
        //     animationDelay: '2s',
        //   })
        ...
        //   nextIndex == 9
        // ) {
        //   $('.nine .content__inner').addClass('animate__animated animate__fadeInLeft').css({
        //     animationDelay: '2s',
        //   })
