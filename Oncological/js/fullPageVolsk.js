$(document).ready(function () {
  if (window.innerWidth > 1200) {
    const video = document.getElementById('video'),
      ...
      timePoints = [4, 9, 14, 18, 22, 26, 31, 35, 39, 43],
      timePointsReverse = [40, 36, 31, 27, 23, 19, 14, 11, 6, 2]
    ...
    $('#fullpage').fullpage({
      navigation: false,
      scrollingSpeed: 4000,
      normalScrollElements: '.contentModal__item',
      onLeave: function (index, nextIndex, direction) {
        ...
        // nine animation
          ...
          $('.nine .content__inner--right').addClass('animate__animated animate__fadeInLeft').css({
            animationDelay: '2s',
          })
